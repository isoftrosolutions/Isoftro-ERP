    ...
    if ($action === 'summary') {
        ...
        if ($reportType === 'collection') {
            ...
            if ($action === 'export_excel') {
                $exportService->exportExcel($headers, $data, "Collection_Report_{$start}_{$end}.xlsx", "Collection Report ($start to $end)");
            } else {
                ob_start();
                ...
                echo '<h2>Collection Report (' . $start . ' to ' . $end . ')</h2>';
                echo '<table>';
                echo '<tr>';
                ...
                echo '<tr><td colspan="6" style="text-align:right"><b>Total</b></td><td><b>' . number_format($total, 2) . '</b></td></tr>';
                echo '</table>';
                $html = ob_get_clean();
                $exportService->exportPdf($html, "Collection_Report.pdf");
            }
        } else {
