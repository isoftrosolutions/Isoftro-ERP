...
async function _loadInstituteProfile() {
    try {
        const res = await fetch(APP_URL + '/api/frontdesk/profile?type=institute');
...
async function _saveInstituteProfile(e) {
    ...
    try {
        const res = await fetch(APP_URL+'/api/frontdesk/profile?type=institute', { method:'POST', body:formData });
...
async function _loadEmailSettings() {
    try {
        const res = await fetch(APP_URL + '/api/frontdesk/email-settings');
...
async function _saveEmailSettings(ev) {
    ...
    try {
        const res = await fetch(APP_URL + '/api/frontdesk/email-settings', { method: 'POST', body: fd });
        const result = await res.json();
        if (result.success) {
            Swal.fire({
                icon: 'success',
...
window.renderUserProfile = async function() {
    ...
    // Load existing data
    try {
        const res = await fetch(APP_URL + '/api/frontdesk/profile?type=user');
        const data = await res.json();
        if (data.success && data.data) {
            const u = data.data;
    ...
    document.getElementById('userProfileForm').onsubmit = async (e) => {
        ...
        try {
            const res = await fetch(APP_URL + '/api/frontdesk/profile?type=user', { method: 'POST', body: fd });
            const result = await res.json();
...
async function _loadBillingData() {
    try {
        const res = await fetch(APP_URL + '/api/frontdesk/billing');
        const data = await res.json();
        if (data.success && data.data) {
            const b = data.data;
...
async function _loadAutomationRules() {
    try {
        const res = await fetch(APP_URL + '/api/frontdesk/automation-rules');
        const r = await res.json();
...
window.openRuleModal = async function(id = null) {
    ...
    if (id) {
        const res = await fetch(APP_URL + `/api/frontdesk/automation-rules?id=${id}`);
        const r = await res.json();
...
async function _load2FAStatus() {
    try {
        const res = await fetch(APP_URL + '/api/frontdesk/2fa_setup?action=status');
        const r = await res.json();
        if(r.success) {
...
async function _toggle2FAEnforcement(enabled) {
    try {
        ...
        const res = await fetch(APP_URL + '/api/frontdesk/2fa_setup', { method: 'POST', body: fd });
        const r = await res.json();
        if(r.success) {
