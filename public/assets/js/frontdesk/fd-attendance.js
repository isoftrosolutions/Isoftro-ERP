...
window.renderAttendanceTake = async function() {
    ...
    try {
        const res = await fetch((window.APP_URL || '') + '/api/frontdesk/batches');
...
window.loadAttendanceRecords = async function() {
    ...
    try {
        const res = await fetch((window.APP_URL || '') + `/api/frontdesk/attendance?batch_id=${batchId}&date=${date}`);
        const data = await res.json();
...
window.saveAttendance = async function() {
    ...
    try {
        ...
        const res = await fetch((window.APP_URL || '') + '/api/frontdesk/attendance', {
            method: 'POST',
...
window.renderAttendanceReport = async function() {
    ...
    try {
        const bRes = await fetch((window.APP_URL || '') + '/api/frontdesk/batches');
...
window.loadAnalytics = async function() {
    ...
    let url = `${window.APP_URL || ''}/api/frontdesk/attendance?action=report&start_date=${startDate}&end_date=${endDate}`;
...
window.exportAttendanceCSV = async function() {
    ...
    let url = `${window.APP_URL || ''}/api/frontdesk/attendance?action=export&start_date=${startDate}&end_date=${endDate}`;
    if (batchId) url += `&batch_id=${batchId}`;
...
window.renderLeaveRequests = async function() {
    ...
    try {
        const res = await fetch((window.APP_URL || '') + '/api/frontdesk/leave-requests?status=pending');
        const data = await res.json();
...
window.actionLeave = async function(btn, id, action) {
    ...
    try {
        ...
        const res = await fetch((window.APP_URL || '') + '/api/frontdesk/leave-requests', {
            method: 'PUT',
            headers: {'Content-Type': 'application/json'},
