...
<script src="<?php echo APP_URL; ?>/assets/js/ia-date-helper.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/nexus-data-loader.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-students.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-students-v2.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-academic.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-academics.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-inquiries.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-staff.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-salary.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-exams.js?v=<?php echo $v; ?>"></script>
...
<script src="<?php echo APP_URL; ?>/assets/js/ia-reports.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-account.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-expenses.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-academic-calendar.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-lms.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-study-materials.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-qbank.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-email-templates.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-emails.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-comms-logs.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-audit-logs.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-support.js?v=<?php echo $v; ?>"></script>
<script src="<?php echo APP_URL; ?>/assets/js/ia-feedback.js?v=<?php echo $v; ?>"></script>
